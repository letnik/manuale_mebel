...
<?php
		...
		public static function __get_max_height_value() {
			return ( isset( self::$settings['instance']['style']['max_height'] ) && absint( self::$settings['instance']['style']['max_height'] ) > 0 ? absint( self::$settings['instance']['style']['max_height'] ) . 'px' : '' );
		}
		...
		public static function __get_max_height() {
			...
			return isset( self::$filter['style']['style']['type'] ) && self::$filter['style']['style']['type'] == 'select' || self::$settings['instance']['style']['style'] == 'pf_select' ? ' style="height:' . self::__get_max_height_value() . ';"' : ' style="max-height:' . self::__get_max_height_value() . ';"';
		}
