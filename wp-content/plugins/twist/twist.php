...
class Twist
{
    ...
    public function __construct()
    {
        $licenseKey=str_replace(' ', '', get_option("Twist_lic_Key", ""));
    ...
    public function Activated()
    {
        ...
        <div class="cix-card-active">
            ...
            <div class="infobox">
				...
				<div class="simpletext"><span><?php echo $this->responseObj->msg ; ?></span><br>If you want to use <?php echo WPGS_NAME ; ?> on another domain, please <a href="https://codecanyon.net/item/twist-product-gallery-slidercarousel-plugin-for-woocommerce/14849108" target="_blank">purchase another license</a></div>
			</div>
        </div>
    <?php
    }
