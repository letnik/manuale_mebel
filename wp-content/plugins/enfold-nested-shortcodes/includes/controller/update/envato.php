...
/**
 * Enfold - Nested Shortcodes - Controller Update Envato
 *
 * Added to work nicely with the autoloader class
 *
 * @since	1.0.0
 */
if ( ! class_exists( 'enscControllerUpdateEnvato' ) )
{

	class enscControllerUpdateEnvato
	{

		/**
		 * Instantiate envato api
		 *
		 * @since 1.0.0
		 */
		public function initialize( $name, $key )
		{

			return new Envato_Protected_API( $name, $key );
